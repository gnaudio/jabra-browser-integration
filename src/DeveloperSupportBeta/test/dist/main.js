...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const browserAndOsVersionTxt = document.getElementById('browserAndOsVersionTxt');
    const player = document.getElementById('player');
    const apiReference = document.getElementById('apiReference');
    let apiReferenceWindow = undefined;
    let devLogStatus = document.getElementById('devLogStatus');
    ...
    function convertParam(value, meta) {
