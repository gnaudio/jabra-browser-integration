...
declare module 'jabra-browser-integration' {
    export * from "jabra-browser-integration/jabra.browser.integration-2.1";
    export * from "jabra-browser-integration/Analytics";
}

declare module 'jabra-browser-integration/jabra.browser.integration-2.1' {
    /**
...
declare module 'jabra-browser-integration/Analytics/AnalyticsEvent' {
    import * as Jabra from "jabra-browser-integration/jabra.browser.integration-2.1";
